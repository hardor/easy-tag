		...
		showDrag: function(e){
			...
			var position = function(context){
				...
				//top_pos =  parseInt(jtagdrag.offset().top) - 254 + border;
                                left_pos = parseInt(jtagdrag.offset().left) - 341 + border;
				top_pos =  parseInt(jtagdrag.offset().top) - 315 + border;
			...
			$(".jTagSaveBtn",container).click(function(){
				...
				//left = $(this).parent().parent().offset().left -91;
                                top_pos = $(this).parent().parent().offset().top - 315;
				left = $(this).parent().parent().offset().left - 341;
